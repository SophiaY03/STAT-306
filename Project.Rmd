...
So we conjecture maybe interaction terms do not really matter. But there is one interesting thing we found that inter3 model has the highest rsq among all non-full regression models although the ineraction term Age*Deep.sleep.percentage do not have an ideal significance.
